package yixin.com.example.animation
...
import yixin.com.example.animation.ui.theme.AnimationTheme
        ...
        setContent {
            AnimationTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                     ...
                     */
                    yixin.com.example.animation.Animation()
                }
            }
        }
    }
...
//位移動畫
    val rocketOffset: Offset by animateOffsetAsState(
    ...
    Column(Modifier.background(backgroundColor)) {
            ...
            AnimatedVisibility(
                ...
                enter = fadeIn(
                    initialAlpha = 0.1f,
                    animationSpec = tween(durationMillis = 5000)) + slideInHorizontally(
                ...
                exit = fadeOut(
                    animationSpec = tween(durationMillis = 5000)) + slideOutHorizontally(
                    animationSpec = tween(durationMillis = 5000)) { fullWidth ->
                    fullWidth / 3
                }
            ) {
